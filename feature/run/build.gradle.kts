...
android {
    namespace = "com.phoneproof.feature.run"
...
dependencies {
    ...
    // api, not implementation: RunState and RunVerdict are parameters of this module's public
    // composables, and the app module builds the session that feeds them.
    api(project(":core:run"))
